...
| **Twilio** | Missed-order robocalls, SMS, 2 numbers | **✓ ~$4/mo** (Jul from console chart; Aug MTD $0.03) | Pay-as-you-go off a prepaid balance ($10.64 available), auto-recharge ON — the "bill" is balance top-ups, not invoices |
| **Anthropic API** | AI menu import, report AI | ~$2–10 est. | scales with /import funnel |
