...
- **T-I. ✅ APPROVED 2026-07-17 ("continue building autonomously from Phase 2") — v1.1 BUILD IN PROGRESS.** Phases 0+1 (unified login) LIVE 2026-07-16. Phase 2 deployed 2026-07-17 (`cd68a19b`): completedAt keyset schema on BOTH branches, terminal stamps, failed-vs-delivered race fix, late-rule helper, backfill. Decided: driver phone VISIBLE to restaurants (Phase 8). Next: Phase 3 driver shell (device gate: real Android build + GPS-while-tab-flipping test with Luigi), then 4–8 per `docs/plans/driver-app-v1.1-plan.md`.
