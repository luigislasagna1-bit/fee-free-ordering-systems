  ...
  return (
    <LegalPageShell title="Privacy Policy" lastUpdated="May 23, 2026" locale={locale}>
      ...
      <ul>
        ...
        <li><strong>PrintNode</strong> — optional kitchen printer bridge for restaurants who opt to print receipts through it (our native Kitchen Order App prints directly over WiFi/LAN without it). Restaurants create their own PrintNode account; we never see their PrintNode credentials.</li>
