...
/**
 * POST { addOnSlug } — schedule cancellation at the end of the current
 * billing period. The customer keeps the feature until currentPeriodEnd.
 * Webhook will flip status to "cancelled" when Stripe deletes the sub.
 */
