  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* ⚠️ No .safe-bottom here — it REPLACES the Tailwind bottom padding
            with env(inset)=0 on desktop (flush-footer bug, Luigi 2026-07-19,
            same as checkout cmrj664ru). The calc() composes inset + padding. */}
        <div className="sticky bottom-0 bg-white border-t border-gray-100 px-5 py-3 pb-[calc(0.75rem+env(safe-area-inset-bottom))] flex items-center gap-2 flex-wrap">
          <button
            onClick={onClose}
