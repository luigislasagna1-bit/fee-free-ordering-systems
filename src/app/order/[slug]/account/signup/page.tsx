    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4 py-10">
      <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-8 max-w-md w-full">
        ...
        <p className="text-sm text-gray-500 mt-1">
          Sign up at <strong>{restaurant.name}</strong> to save your details and unlock
          coupons the restaurant sends you. Takes 30 seconds.
        </p>
        ...
        <p className="mt-2 text-[11px] text-gray-400 text-center leading-snug">
          This account is for <strong>{restaurant.name}</strong> only — separate from any
          marketplace account you may have at feefreefood.com.
        </p>
      </div>
    </div>
  );
