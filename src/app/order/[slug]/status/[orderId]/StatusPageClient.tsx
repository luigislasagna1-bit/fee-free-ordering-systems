...
// Client half of the order-status page. The server page.tsx resolves the
// locale (cookie → restaurant default → en) and mounts the provider —
// Fabrizio cms0gyexp follow-up: a customer opening the emailed link in a
// fresh browser (no language cookie) saw this page + its cancel modal in
// English on an Italian store.
export function StatusPageClient({ slug, orderId }: { slug: string; orderId: string }) {
