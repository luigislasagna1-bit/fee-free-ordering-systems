...
export function HomeClient({ locale }: { locale: string }) {
  ...
  return (
    <div className="min-h-screen bg-white flex flex-col">
      ...
      {/* Hero */}
      <section className="bg-gradient-to-br from-emerald-500 to-red-600 text-white py-24 px-4">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <p className="text-xl text-emerald-100 mb-10 max-w-2xl mx-auto">{t("heroSubtitle")}</p>
      ...
      <section className="py-20 px-4">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <Link href="/features" className="text-emerald-500 font-medium hover:underline">
            {t("viewDemo")} →
          </Link>
        </div>
      </section>
