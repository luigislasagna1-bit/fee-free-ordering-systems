...
import { LayoutDashboard, Store, CreditCard, Mail, LogOut, Zap, Users, Wallet, Sparkles, Bug, Bell, Map as MapIcon, Building2 } from "lucide-react";
...
const items = [
  ...
  { href: "/superadmin/settings/company", label: "Company / Invoicing", icon: Building2 },
];
