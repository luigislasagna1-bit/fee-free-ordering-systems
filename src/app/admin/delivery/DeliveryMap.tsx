...
const restaurantIcon = L.divIcon({
  html: `<div style="width:20px;height:20px;background:#f97316;border:3px solid white;border-radius:50%;box-shadow:0 2px 8px rgba(0,0,0,0.4);cursor:grab"></div>`,
  className: "", iconSize: [20, 20], iconAnchor: [10, 10],
});

function LeafletVariant({
  restaurantLat, restaurantLng, zones, selectedZoneId, onZoneClick, onRestaurantMove,
}: Props) {
  const hasLocation = isValidCoord(restaurantLat, restaurantLng);
