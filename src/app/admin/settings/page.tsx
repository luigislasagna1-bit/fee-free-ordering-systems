...
import { SettingsClient, type ActiveAddOn } from "./SettingsClient";
...
export default async function SettingsPage() {
  ...
  const [restaurant, addOnRows] = restaurantId
    ? await Promise.all([
  ...
  return <SettingsClient restaurant={restaurant} activeAddOns={activeAddOns} />;
}
