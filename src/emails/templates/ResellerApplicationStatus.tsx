      ...
      <EmailBody>
        ...
        {variant === "approved" && (
          <>
            ...
            <P size="sm" muted>
              Commission rate scales with active paying restaurants — 5% at 6+, 10% at 50+. Earnings hold for 7 days after each invoice paid (in case of refunds) and become available for payout once cleared. Minimum payout is $50.
            </P>
          </>
        )}
